...
pkgdown::build_article("Bootstrap_models_in_R")
pkgdown::build_article("Model_theory")
pkgdown::build_article("STEM_compatibility")
pkgdown::build_article("Excel_example_ex1")
pkgdown::build_article("Excel_example_ex2")
pkgdown::build_article("Excel_example_ex3")
